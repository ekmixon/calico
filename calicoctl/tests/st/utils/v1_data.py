...
data = {
    ...
    'profile_tame': {
        ...
        'spec': {
            'egress': [{'action': 'allow'}],
            'ingress': [
                {'action': 'deny', 'source': {'nets': ['10.0.20.0/24']}},
                {
                    'action': 'allow',
    ...
    'policy_big': {
        ...
        'spec': {
            ...
            'ingress': [
                ...
                {
                    'action': 'deny',
                    'destination': {'notPorts': [80], 'ports': [22, 443]},
                    'protocol': 'tcp',
                },
                {
                    'action': 'allow',
                    'source': {'nets': ['172.18.18.200/32', '172.18.19.0/24']},
                },
                {'action': 'allow', 'source': {'net': '172.18.18.100/32'}},
                {'action': 'deny', 'source': {'notNet': '172.19.19.100/32'}},
                {'action': 'deny', 'source': {'notNets': ['172.18.0.0/16']}},
            ],
            'order': 1234,
    ...
    'wep_lots_ips': {
        ...
        'metadata': {
            'labels': {'app': 'frontend', 'calico/k8s_ns': 'default'},
            'name': 'eth0',
            'node': 'rack1-host1',
            'orchestrator': 'k8s',
    ...
    'prednat_policy': {
        ...
        'spec': {
            'ingress': [
                {
                    'action': 'allow',
                    'source': {'nets': ['10.240.0.0/16', '192.168.0.0/16']},
                }
            ],
            'order': 10,
            'preDNAT': True,
